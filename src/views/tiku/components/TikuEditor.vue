...
export default {
  ...
  props: {
    ...
    plugins: {
      type: [String, Array],
      default: 'lists image link media table wordcount fullscreen charmap'
    },
    toolbar: {
      type: [String, Array],
      default: 'bold italic | alignleft aligncenter alignright alignjustify | removeformat charmap image',
      branding: false
    }
  },
  data() {
