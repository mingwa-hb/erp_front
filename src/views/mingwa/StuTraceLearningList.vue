<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      <a-button type="primary" icon="download" @click="handleExportXls('学习信息变更表_'+time)">导出</a-button>
...
export default {
  name: 'StuTraceApplyLearningList',
  ...
  data() {
    ...
    return {
      ...
      url: {
        list: '/erp/sysTrace/list/6',
        exportXlsUrl: 'erp/sysTrace/exportXls/6',
