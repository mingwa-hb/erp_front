...
export default {
  ...
  props: {
    ...
    plugins: {
      type: [String, Array],
      default: 'lists image link media table textcolor wordcount contextmenu fullscreen charmap'
    },
    toolbar: {
      type: [String, Array],
      default:
        'undo redo |  formatselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat charmap | lists link unlink image media table | fullscreen',
      branding: false
    }
  },
  data() {
